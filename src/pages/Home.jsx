        ...
        return (
            <React.Fragment>
                <div className="intro-div">
                    ...
                    {/* 2 buttons for go to repo and create pages*/}
                    <div className="container d-flex justify-content-center pb-5">
                        <Buttons text = {"VISIT REPO (DEV)"} style_class ={"btn-secondary mb-1"} link = {"https://github.com/kavindu-mane/profile-readme-generator"}/>
                        <Buttons style_class = {"btn-primary mb-1"} text = {"GET START"} link = {"create"}/>
                    </div>
                </div>
            </React.Fragment>
        );
