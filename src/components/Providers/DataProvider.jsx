...
const DataProvider = ({children}) => {
    ...
    const [data, setData] = useState({
      ...
      skill: {
        title: "🖥️ \tTech Stack",
        value: [
          ["apache groovy", false, returnOriginalIcon("groovy"), "4298b8"], // languages
          ...
          [
            "octave",
            false,
            "https://upload.wikimedia.org/wikipedia/commons/6/6a/Gnu-octave-logo.svg",
            "e87b0e",
          ],
          ...
          [
            "nativescript",
            false,
            returnWorldVectorLogo("nativescript"),
            "1b4fbf",
          ],
          ...
          [
            "apache cordova",
            false,
            returnVectorLogo("apache_cordova"),
            "505052",
          ],
          ...
          [
            "apache cassandra",
            false,
            returnWorldVectorLogo("cassandra"),
            "1287b1",
          ],
          [
            "hive",
          ...
          [
            "cockroachdb",
            false,
            returnWorldVectorLogo("cockroachdb"),
            "3b8f33",
          ],
          [
            "elasticsearch",
            false,
            returnWorldVectorLogo("elasticsearch"),
            "2f9e76",
          ],
          [
          ...
          [
            "amazon aws",
            false,
            returnOriginalWordmarkIcon("amazonwebservices"),
            "FF9900",
          ],
          ...
          [
            "unreal engine",
            false,
            returnJsdelivrDevicons("unrealengine"),
            "282829",
          ],
          ...
          [
            "adobe illustrator",
            false,
            returnVectorLogo("adobe_illustrator"),
            "bfb034",
          ],
          ...
          ["wordpress", false, returnOriginalIcon("wordpress"), "3473d9"],
        ],
        active: false,
        align: "left",
        "logo-type": "Flat",
